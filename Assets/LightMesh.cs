...
{
    public static LightMesh Instance;
    ...
    public void GenerateMesh(float squareSize)
    {
        ...
        squareGrid = new SquareGrid(squareSize);
        ...
        {
            for (int y = squareGrid.squares.GetLength(1) - 1; y >= 0; y--)
            {
        ...
        {
            float percentX = Mathf.InverseLerp(-GameMaster.gm.mapGen.width / 2 * squareSize, GameMaster.gm.mapGen.width / 2 * squareSize, vertices[i].x) * tileAmount;
            float percentY = Mathf.InverseLerp(-GameMaster.gm.mapGen.width / 2 * squareSize, GameMaster.gm.mapGen.width / 2 * squareSize, vertices[i].z) * tileAmount;
